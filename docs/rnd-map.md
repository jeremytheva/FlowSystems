...
graph TD
    ...
    %% --- Stage 2: Behavioural Understanding ---
    ...
    %% --- Stage 5: Integration ---
    subgraph Stage5[Stage 5 – Integration & Cohesion]
        F0[5.1 Integrated Experience Design]
        F1[5.2 Community Template Library]
        F2[5.3 SmartEx + FlowBot Sync]
    end
    ...
    %% --- Stage 6: Refinement & Expansion ---
    subgraph Stage6[Stage 6 – Refinement & Expansion]
        G0[6.1 Micro-Games & Profiler Refinement]
        G1[6.2 Extended SmartEx Context]
        G2[6.3 Extended Template Ecosystem]
    end
