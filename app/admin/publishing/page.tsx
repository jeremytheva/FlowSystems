...
import { publishingTasks } from "../../data/admin/tasks";

export default function Page() {
  return (
    <div className="space-y-8">
      <header className="space-y-2">
        <h1 className="text-3xl font-bold text-slate-900">Publishing Workflow</h1>
        <p className="text-sm text-slate-600">
          Coordinate release readiness across reviews, stacks, and platform profiles.
        </p>
      </header>

      <Section eyebrow="Tasks" title="Content shipping soon" contentClassName="space-y-4">
